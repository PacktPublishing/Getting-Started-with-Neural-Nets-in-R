...
Neural Nets from Scratch using R 
===================================

Neural Network Functions 
=========================

1. neuralnetwork function 
===========================
...
weights = weights - (learning rate/number in batch)*nabla weights
...
We downloaded the data - mnist_train.csv ( training ) and mnist_test.csv ( testing)

```{r}
# Train
mnist <- read.table('mnist_train.csv', sep=",", header = FALSE)
mnist$V1 <- factor(mnist$V1)
training_data <- train_test_from_df(df = mnist, predict_col_index = 1, train_ratio = 1)[[1]]

# Test
mnist <- read.table('mnist_test.csv', sep=",", header = FALSE)
mnist$V1 <- factor(mnist$V1)
